...
:::info
The following methods for creating custom context providers are deprecated. We recommend using HTTP context providers, [MCP Servers](../customization/mcp-tools.mdx), and [Prompts](../advanced/deep-dives/prompts.md) where possible.
:::
...
const continueExt = vscode.extensions.getExtension("Continue613.continue613");
