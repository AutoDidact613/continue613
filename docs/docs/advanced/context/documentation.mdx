...
@Docs uses [`docs` blocks](../../hub/blocks/block-types.md#docs) in Assistants from the hub. Visit the hub to [explore `docs` blocks](https://hub.continue613.dev/explore/docs) or [create your own](https://hub.continue613.dev/new?type=block&blockType=docs).
