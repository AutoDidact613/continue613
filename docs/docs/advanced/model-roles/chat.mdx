...
<Tabs groupId="hub-config-example">
  ...
  View the [Claude 3.7 Sonnet model block](https://hub.continue613.dev/anthropic/claude-3-7-sonnet) on the hub.
  </TabItem>
...
<Tabs groupId="config-example">
  <TabItem value="hub" label="Hub">
    <Tabs groupId="providers">
        ...
        Add the [Ollama Gemma 3 27B block](https://hub.continue613.dev/ollama/gemma3-27b) from the hub
        </TabItem>
        <TabItem value="Together">
        Add the [Together Gemma 2 27B Instruct block](https://hub.continue613.dev/togetherai/gemma-2-instruct-27b) from the hub
        </TabItem>
    </Tabs>
  </TabItem>
  <TabItem value="yaml" label="YAML">
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [OpenAI GPT-4o block](https://hub.continue613.dev/openai/gpt-4o) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [xAI Grok-2 block](https://hub.continue613.dev/xai/grok-2) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [Gemini 2.0 Flash block](https://hub.continue613.dev/google/gemini-2.0-flash) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
  <TabItem value="hub" label="Hub">
    ...
    Add the [Ollama Llama 3.1 8b block](https://hub.continue613.dev/ollama/llama3.1-8b) from the hub
    </TabItem>
    {/* HUB_TODO nonexistent block */}
    {/* <TabItem value="lmstudio" label="LM Studio">
    Add the [LM Studio Llama 3.1 8b block](https://hub.continue613.dev/explore/models) from the hub
    </TabItem> */}
    </Tabs>
  </TabItem>
  <TabItem value="yaml" label="YAML">
...
<Tabs groupId="config-example">
  ...
  {/* <TabItem value="hub" label="Hub">
    <Tabs groupId="providers">
    <TabItem value="ollama" label="Ollama">
    Add the [Ollama Deepseek Coder 2 16B block](https://hub.continue613.dev/explore/models) from the hub
    </TabItem>
    <TabItem value="lmstudio" label="LM Studio">
    Add the [LM Studio Deepseek Coder 2 16B block](https://hub.continue613.dev/explore/models) from the hub
    </TabItem>
    </Tabs>
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
