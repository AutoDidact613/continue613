...
<Tabs groupId="hub-config-example">
  ...
  [Voyage Rerank 2 Block](https://hub.continue613.dev/voyageai/rerank-2)
  </TabItem>
...
<Tabs groupId="config-example">
  ...
  {/* <TabItem value="hub" label="Hub">
  [Cohere Reranker English v3](https://hub.continue613.dev/)
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="config-example">
  {/* HUB_TODO block doesn't exist */}
  {/* <TabItem value="hub" label="Hub">
  [GPT-4o LLM Reranker Block](https://hub.continue613.dev/)
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="config-example">
  {/* HUB_TODO */}
  {/* <TabItem value="hub" label="Hub">
  [HuggingFace TEI Reranker block](https://hub.continue613.dev/)
  </TabItem> */}
    <TabItem value="yaml" label="YAML">
    ```yaml title="config.yaml"
    models:
