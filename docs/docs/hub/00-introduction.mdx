---
title: Introduction
description: Introduction to Continue Hub for creating and managing AI assistants
keywords: [continue, hub, introduction, assistants, blocks]
---
...
[Continue Hub](https://hub.continue613.dev) makes it simple to create custom AI code [assistants](./assistants/00-intro.md), providing a registry for defining, managing, and sharing assistant [building blocks](./blocks/00-intro.md).
