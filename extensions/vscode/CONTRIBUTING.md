...
2. Open the Continue React app in a side panel. The React app's source code lives in the `gui` directory. The panel is opened by the `continue613.openContinueGUI` command, as defined in `src/commands.ts`.
