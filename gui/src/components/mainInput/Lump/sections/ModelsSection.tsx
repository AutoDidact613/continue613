    ...
    <div>
      <div className="text-[${getFontSize() - 1}px] grid grid-cols-1 gap-x-2 gap-y-1 sm:grid-cols-[auto_1fr]">
        <ModelRoleSelector
          ...
          setupURL="https://docs.continue613.dev/chat/model-setup"
        />
        <ModelRoleSelector
          ...
          setupURL="https://docs.continue613.dev/autocomplete/model-setup"
        />
        ...
        {!jetbrains && (
          <ModelRoleSelector
            ...
            setupURL="https://docs.continue613.dev/edit/model-setup"
          />
        )}
        <ModelRoleSelector
          displayName="Apply"
          ...
          setupURL="https://docs.continue613.dev/customize/model-roles/apply"
        />
        <ModelRoleSelector
          displayName="Embed"
          ...
          setupURL="https://docs.continue613.dev/customize/model-roles/embeddings"
        />
        <ModelRoleSelector
          displayName="Rerank"
          ...
          setupURL="https://docs.continue613.dev/customize/model-roles/reranking"
        />
      </div>
    </div>
  );
